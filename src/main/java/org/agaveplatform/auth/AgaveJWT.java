...
public class AgaveJWT {
    ...
    public JWT getSignedJwtForUser(String username) throws Exception {
        ...
        JWTClaimsSet claimsSet = new JWTClaimsSet.Builder()
                ...
                .claim(API_GATEWAY_ID + "/enduser", "agaveadmin")
                .claim(API_GATEWAY_ID + "/enduserTenantId", "-1234")
                .claim(API_GATEWAY_ID + "/emailaddress", "agaveadmin@examoke.com")
                .claim(API_GATEWAY_ID + "/fullname", "API Admin")
                .claim(API_GATEWAY_ID + "/givenname", "API")
                .claim(API_GATEWAY_ID + "/lastname", "Admin")
